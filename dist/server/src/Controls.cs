...
namespace NtoNServerControl
{
    ...
    public class TitleBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillRectangle(new SolidBrush(t.TitleBg), 0, 0, Width, Height);
            ...
            TextRenderer.DrawText(g, "N", new Font("Segoe UI", 10, FontStyle.Bold), logo, Color.White,
    ...
    public class ThemedCheckBox : CheckBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var g = e.Graphics;
            g.SmoothingMode = SmoothingMode.AntiAlias;
            g.FillRectangle(new SolidBrush(t.WindowBg), 0, 0, Width, Height);
    ...
    public class DrawerMenu : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                g.FillRectangle(new SolidBrush(t.CardBg), 0, 0, Width, Height);
